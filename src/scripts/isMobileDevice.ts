...
const isMobileDevice = () => {
  ...
  const isMobileUserAgent = () => {
    ...
    // Regexes copy-pasted from http://detectmobilebrowsers.com/
    const regexAgents =
    ...
    return (
      regexAgents.test(agent) || regexSecondary.test(agent.substring(0, 4))
    );
  };

  // Check if the device has a touchscreen or orientation rotation.
  // Note: either use this or the above function
  //   const isTouchScreen = () => {
